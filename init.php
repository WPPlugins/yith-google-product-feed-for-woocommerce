...
/*
Plugin Name: YITH Google Product Feed for WooCommerce
Plugin URI: https://yithemes.com/themes/plugins/yith-google-product-feed-for-woocommerce/
Description: YITH Google Product Feed for WooCommerce.
Author: YITHEMES
...
if( ! function_exists( 'yith_wcgpf_install_woocommerce_admin_notice' ) ) {
    ...
    function yith_wcgpf_install_woocommerce_admin_notice() { ?>
        <div class="error">
            <p><?php _ex( 'YITH Google Product Feed for WooCommerce is enabled but not effective. It requires WooCommerce in order to work.', 'Alert Message: WooCommerce requires', 'yith-google-product-feed-for-woocommerce' ); ?></p>
        </div>
        <?php
    }
}
...
/* === DEFINE === */
! defined( 'YITH_WCGPF_VERSION' )            && define( 'YITH_WCGPF_VERSION', '1.0.0' );
! defined( 'YITH_WCGPF_FREE_INIT' )          && define( 'YITH_WCGPF_FREE_INIT', plugin_basename( __FILE__ ) );
! defined( 'YITH_WCGPF_SLUG' )               && define( 'YITH_WCGPF_SLUG', 'yith-google-product-feed-for-woocommerce' );
! defined( 'YITH_WCGPF_SECRETKEY' )          && define( 'YITH_WCGPF_SECRETKEY', '67WiDt54JQy26P0jVJqE' );
...
! defined( 'YITH_WCGPF_OPTIONS_PATH' )       && define( 'YITH_WCGPF_OPTIONS_PATH', YITH_WCGPF_PATH . 'panel' );
...
add_action( 'yith_wcgpf_init', 'yith_wcgpf_init' );